...
def image_angle_from_horizontal(vector: Union[Tuple[float, float], List[float], np.ndarray]) -> float:
    """
...
def angle_between_vectors(vector1: Union[List[float], Tuple[float, ...], np.ndarray], 
                          vector2: Union[List[float], Tuple[float, ...], np.ndarray]) -> float:
    """
...
def vector_relative_to_origin(origin: Union[List[float], Tuple[float, ...], np.ndarray],
                     vector: Union[List[float], Tuple[float, ...], np.ndarray]) -> np.ndarray:
    """
...
def scale_vector(vector: Union[List[float], Tuple[float, ...], np.ndarray],
                 scale: Union[float, int, List[float], Tuple[float, ...], np.ndarray]) -> np.ndarray:
    """
...
def process_config_files(image_feature_path: str,
                         user_feature_list_path: str,
                         chip_map_path: str
...
def find_all_labels(target: np.ndarray,
